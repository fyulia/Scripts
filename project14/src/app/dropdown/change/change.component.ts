...
/////////////////////////////////
  ...
  initGroup() {
    ...
    this.formChanger = this.form_build.group
      ...
      ({
        ...
        number: new FormControl((this.worker.number), [Validators.pattern(numCheck),Validators.required])
      })
  ...
  change_worker() {
    ...
    this.changeWorker.emit({
      ...
      number: this.formChanger.value.number,
    });
    console.log( (this.formChanger.value.number))
